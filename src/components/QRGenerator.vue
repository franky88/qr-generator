    ...
    <div class="col-sm-4">
      <div class="card card-body mb-2">
        ...
        <div class="mb-3 input-group">
          ...
          <button class="btn btn-outline-primary btn-sm" type="button" id="uplFile" @click="uploadImg">
            Upload
          </button>
        </div>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                <p class="card-title">
                  {{ imageName }} |
                  <small class="text-muted" v-show="imageBase64">File size: {{ imageSize }} KB</small>
                </p>
                <!-- <a :href="image.src" target="_blank"><small class="text-muted">View Image</small></a> -->
                <button v-show="imageBase64" class="btn btn-outline-danger btn-sm" @click="clearImage">
                  Clear
                </button>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card card-body mb-2">
            ...
            >
            <hr />
            <button class="btn btn-outline-primary btn-sm" v-show="genLink" @click="savePDF">
    ...
    <div class="col-sm-6">
      <div class="card" style="text-align: center; padding: 20px">
        <div class="card-body mb-3">
          <div id="toPDFFile">
            <h1 class="card-title" style="text-align: center" v-if="busName == ''">
              Ad On Group
            </h1>
            <h1 class="card-title" style="text-align: center; width: 400px;" v-else-if="busName">
              {{ busName }}
            </h1>
            <h4 style="text-align: center; padding: 20px 0 20px 0;">values your feedback.</h4>
            <div id="qrcode" style="text-align: center; width: 100%; height: auto;">
            </div>
            ...
            <h4 style="text-align: center; padding: 20px 0 20px 0;">powered by</h4>
